...
const MyLibrary = () => {
    ...
    const fetchAllBooks = async () => {
        try {
            ...
            const res = await axios.get("https://library-management-system-0haj.onrender.com/api/books/");
            setBooks(res.data);
                                ...
                                <div className="col-12 col-md-6 col-lg-4" key={book.id}>
                                    <div className="card border-0 shadow-sm rounded-4 h-100 overflow-hidden">
                                        ...
                                        <div className="d-flex justify-content-center align-items-center p-4 bg-white border-bottom" style={{height: '250px'}}>
                                            {book.cover_image ? (
                                                <img 
                                                    src={`https://library-management-system-0haj.onrender.com${book.cover_image}`} 
                                                    alt={book.title} 
