...
const API_URL = "http://[https://library-management-system-0haj.onrender.com](https://library-management-system-0haj.onrender.com)/api/author/";
...
const ManageAuthor = () => {
    ...
    // Sirf id aur name lenge, kyunki Author model me is_active nahi hai
    ...
    //----------------------------------------
    // Update Author (Only Update, Add is on different page)
    //----------------------------------------
            ...
            <div className="container">
                ...
                <div className="d-flex justify-content-between align-items-start mb-5">
                    <div className="d-flex align-items-start">
                        ...
                        <div>
                            <h2 className="fw-bold text-dark fs-4 mb-1">Manage Authors</h2>
                            <p className="text-muted small mb-0">
                                View, edit and delete book authors from the library.
                            </p>
                        </div>
                    </div>
                    ...
                    {!isEditing && (
                        <button 
                            className="btn btn-outline-primary fw-medium px-3 py-2 bg-white" 
                            onClick={() => navigate('/admin/author-add')}// Add Page par bhejega
                        >
                            + Add New
                        </button>
                    )}
                ...
                <div className="row">
                    {/* Left Card: Edit Form or Placeholder */}
                    <div className="col-lg-4 mb-4">
                        {isEditing ? (
                            ...
                            <div className="card border-0 shadow-sm rounded-4 d-flex align-items-center justify-content-center text-center px-4" style={{ minHeight: "300px" }}>
                                <div className="text-muted">
                                    ...
                                    <h5 className="fw-semibold text-dark">No Author Selected</h5>
                                    <p className="small mb-0 mt-2">
                                        Please select an author from the list to edit their details here.
                                    </p>
                                </div>
                            </div>
                        )}
                    ...
                    <div className="col-lg-8">
                        <div className="card border-0 shadow-sm rounded-4">
                            <div className="card-header bg-transparent border-0 d-flex justify-content-between align-items-center pt-4 px-4 pb-2">
                                <span className="fw-bold text-dark">Authors Listing</span>
                                <input 
                                    type="text" 
