...
const UserProfile = () => {
    ...
    const fetchProfileData = async (id) => {
        try {
            const res = await axios.get(`http://127.0.0.1:8000/api/student/profile/${id}/`);
            if (res.data.success) {
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            setLoading(true);
            const res = await axios.put(`http://127.0.0.1:8000/api/student/profile/${studentId}/update/`, {
                full_name: fullName,
                mobile: mobile
            });
