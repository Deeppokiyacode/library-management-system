...
const IssueBook = () => {
    ...
    const handleFindStudent = async () => {
        ...
        try {
            ...
            const res = await axios.get(`https://library-management-system-0haj.onrender.com/api/issue-book/search-student/${studentIdInput}/`);
            if (res.data.success) {
    ...
    const handleFindBook = async () => {
        ...
        try {
            setLoadingBook(true);
            const res = await axios.get(`https://library-management-system-0haj.onrender.com/api/issue-book/search-book/${bookIsbnInput}/`);
            if (res.data.success) {
    ...
    const handleIssueBook = async (e) => {
        ...
        try {
            setIssuing(true);
            const res = await axios.post("https://library-management-system-0haj.onrender.com/api/issue-book/submit/", {
                            ...
                            <div className="card border-0 shadow-sm rounded-4">
                                <div className="card-body p-4 d-flex gap-3 align-items-center">
                                    {foundBook.cover_image ? (
                                        <img src={`https://library-management-system-0haj.onrender.com${foundBook.cover_image}`} alt="cover" className="rounded shadow-sm" style={{width: '50px', height: '65px', objectFit: 'cover'}} />
                                    ) : (
